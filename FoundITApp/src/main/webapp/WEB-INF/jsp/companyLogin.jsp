...
<body style="padding-top:70px;">
	<nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        ...
        <ul class="nav navbar-nav navbar-right">
              <li><a href="/FoundITApp/login">User Login</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
		...
		<form action="processCompanyLogin" method="post" id="loginForm">
			...
			<div class="form-group">
				<label for="ManagerEmail">Manager's Email Address</label>
		...
		<form method="post" action="companyRegisterForm" id="companyRegisterForm">
		</form>
		<button type="submit" class="btn btn-default" form="loginForm">Submit</button>
		<button type="submit" class="btn btn-default" form="companyRegisterForm">Sign Up</button>
	</div>
